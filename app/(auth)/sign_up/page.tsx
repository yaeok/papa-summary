      ...
      <div className='w-full lg:w-1/4 bg-gray-50 rounded-lg p-8 shadow-md flex flex-col items-center gap-4'>
        <form onSubmit={onSubmit} className='w-full space-y-4'>
          ...
          <section className='flex justify-center'>
            <button
              type='submit'
              className='px-4 py-2 rounded-full bg-blue-400 text-white font-semibold shadow-md hover:bg-blue-500 hover:shadow-none hover:translate-y-1 hover:duration-300 transition-all'
            >
              新規登録
            </button>
          </section>
